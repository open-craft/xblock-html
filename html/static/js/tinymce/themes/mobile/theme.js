...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_7mdm7y8jlhp4o7x.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_7mdm7y8jlhp4o7x.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_7mdm7y8jlhp4o7x.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_c115l8ydjlhp4o8m = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_c115l8ydjlhp4o8m.browsers();
    var oses = $_c115l8ydjlhp4o8m.oses();
    var browser = $_cifmppybjlhp4o89.detectBrowser(browsers, userAgent).fold($_fnhqm8y7jlhp4o7s.unknown, $_fnhqm8y7jlhp4o7s.nu);
    var os = $_cifmppybjlhp4o89.detectOs(oses, userAgent).fold($_7twowsy9jlhp4o7z.unknown, $_7twowsy9jlhp4o7z.nu);
  ...
  var $_fcdzsny6jlhp4o7q = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_fcdzsny6jlhp4o7q.detect(userAgent);
  });
  var $_97e13cy3jlhp4o6s = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_97e13cy3jlhp4o6s.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_5eqpneyljlhp4oaf.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_5eqpneyljlhp4oaf.ELEMENT);
  var isText = isType$1($_5eqpneyljlhp4oaf.TEXT);
  var isDocument = isType$1($_5eqpneyljlhp4oaf.DOCUMENT);
  var $_cmqrgzykjlhp4oad = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_cmqrgzykjlhp4oad.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_zqup1ysjlhp4obf = { toArray: toArray };
  ...
  var $_2wizs3yvjlhp4obw = { getOrDie: getOrDie };

  var node = function () {
    var f = $_2wizs3yvjlhp4obw.getOrDie('Node');
    return f;
  };
  ...
  var $_8xmou0yujlhp4obv = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_5eqpneyljlhp4oaf.ELEMENT;
  var DOCUMENT = $_5eqpneyljlhp4oaf.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_8xmou0yujlhp4obv.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_97e13cy3jlhp4o6s.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_ckoxm1ytjlhp4obh = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_c9j7i8yyjlhp4oc5.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_ckoxm1ytjlhp4obh.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_ckoxm1ytjlhp4obh.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_zqup1ysjlhp4obf.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_zqup1ysjlhp4obf.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_czfm61ynjlhp4oal.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_czfm61ynjlhp4oal.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_czfm61ynjlhp4oal.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_czfm61ynjlhp4oal.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_bmvospymjlhp4oai.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_bmvospymjlhp4oai.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_bmvospymjlhp4oai.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_bmvospymjlhp4oai.append(parent, x);
    });
  };
  var $_cfe7gqz0jlhp4ocp = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_czfm61ynjlhp4oal.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_czfm61ynjlhp4oal.children(wrapper);
    if (children.length > 0)
      $_cfe7gqz0jlhp4ocp.before(wrapper, children);
    remove(wrapper);
  };
  var $_alqyuxyzjlhp4ocj = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_bmvospymjlhp4oai.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_fgaic0yijlhp4o9q.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_alqyuxyzjlhp4ocj.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_czfm61ynjlhp4oal.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_alqyuxyzjlhp4ocj.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_bmvospymjlhp4oai.append(element, guiSystem.element());
    var children = $_czfm61ynjlhp4oal.children(guiSystem.element());
  ...
  var json = function () {
    return $_2wizs3yvjlhp4obw.getOrDie('JSON');
  };
  ...
  var $_a364e1zhjlhp4oh5 = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_a364e1zhjlhp4oh5.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_ckoxm1ytjlhp4obh.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_a364e1zhjlhp4oh5.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_a364e1zhjlhp4oh5.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_a364e1zhjlhp4oh5.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_cmqrgzykjlhp4oad.isElement(source) || !$_cmqrgzykjlhp4oad.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_fo5bp1zwjlhp4oxk = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get,
  ...
  var read$1 = function (element, attr) {
    var value = $_fo5bp1zwjlhp4oxk.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_fo5bp1zwjlhp4oxk.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_fo5bp1zwjlhp4oxk.remove(element, attr);
    return false;
  };
  var $_1ey70lzyjlhp4p04 = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$1 = function (element) {
    return $_1ey70lzyjlhp4p04.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_1ey70lzyjlhp4p04.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_1ey70lzyjlhp4p04.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_867uq6zxjlhp4ozj.supports(element))
      element.dom().classList.add(clazz);
    else
      $_867uq6zxjlhp4ozj.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_867uq6zxjlhp4ozj.supports(element) ? element.dom().classList : $_867uq6zxjlhp4ozj.get(element);
    if (classList.length === 0) {
      $_fo5bp1zwjlhp4oxk.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_867uq6zxjlhp4ozj.supports(element)) {
      ...
      $_867uq6zxjlhp4ozj.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_867uq6zxjlhp4ozj.supports(element) ? element.dom().classList.toggle(clazz) : $_867uq6zxjlhp4ozj.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_867uq6zxjlhp4ozj.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$1 = function (element, clazz) {
    return $_867uq6zxjlhp4ozj.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_7pgsr6zujlhp4owp = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_7pgsr6zujlhp4owp.remove(element, removeCls);
    $_7pgsr6zujlhp4owp.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_7pgsr6zujlhp4owp.remove(component.element(), swapConfig.alpha());
    $_7pgsr6zujlhp4owp.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_7pgsr6zujlhp4owp.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_7pgsr6zujlhp4owp.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_fgaic0yijlhp4o9q.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_ckoxm1ytjlhp4obh.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_46tilw103jlhp4p1x.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_46tilw103jlhp4p1x.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_46tilw103jlhp4p1x.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_46tilw103jlhp4p1x.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_46tilw103jlhp4p1x.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_46tilw103jlhp4p1x.descendant(scope, predicate).isSome();
  };
  var $_3rzubj102jlhp4p1t = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_czfm61ynjlhp4oal.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_czfm61ynjlhp4oal.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_3rzubj102jlhp4p1t.closest(a, curry($_ckoxm1ytjlhp4obh.eq, element));
    });
  ...
  var search = function (element) {
    return active($_czfm61ynjlhp4oal.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_eaees2101jlhp4p1e = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_9ehpmy107jlhp4p3g = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_czfm61ynjlhp4oal.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_czfm61ynjlhp4oal.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_brjc10gjlhp4p6q.fromHtml(content, docDom);
    $_cfe7gqz0jlhp4ocp.append(fragment, contentElements);
    $_alqyuxyzjlhp4ocj.empty(element);
    $_bmvospymjlhp4oai.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_bmvospymjlhp4oai.append(container, clone);
    return get$2(container);
  };
  var $_6q029v10fjlhp4p6n = {
    get: get$2,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_fo5bp1zwjlhp4oxk.clone(original);
    $_fo5bp1zwjlhp4oxk.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_czfm61ynjlhp4oal.children(deep$1(original));
    $_cfe7gqz0jlhp4ocp.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_bmvospymjlhp4oai.before(original, nu);
    var children = $_czfm61ynjlhp4oal.children(original);
    $_cfe7gqz0jlhp4ocp.append(nu, children);
    $_alqyuxyzjlhp4ocj.remove(original);
    return nu;
  };
  var $_8ao3yv10hjlhp4p6w = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_8ao3yv10hjlhp4p6w.shallow(element);
    return $_6q029v10fjlhp4p6n.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_7pgsr6zujlhp4owp.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_7pgsr6zujlhp4owp.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_7pgsr6zujlhp4owp.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_7pgsr6zujlhp4owp.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_fo5bp1zwjlhp4oxk.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_fo5bp1zwjlhp4oxk.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_fo5bp1zwjlhp4oxk.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_fo5bp1zwjlhp4oxk.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_dzhzl109jlhp4p3x.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_dzhzl109jlhp4p3x.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_97e13cy3jlhp4o6s.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_eaees2101jlhp4p1e.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_eaees2101jlhp4p1e.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_eaees2101jlhp4p1e.hasFocus(component.element());
  };
  ...
  var $_ag6kcc117jlhp4pfr = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_ag6kcc117jlhp4pfr.isSupported(dom))
  ...
  var get$3 = function (element, property) {
    ...
    var v = r === '' && !$_fgaic0yijlhp4o9q.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_ag6kcc117jlhp4pfr.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_fo5bp1zwjlhp4oxk.has(element, 'style') && trim($_fo5bp1zwjlhp4oxk.get(element, 'style')) === '') {
      $_fo5bp1zwjlhp4oxk.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_fo5bp1zwjlhp4oxk.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_fo5bp1zwjlhp4oxk.remove : $_fo5bp1zwjlhp4oxk.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_ag6kcc117jlhp4pfr.isSupported(sourceDom) && $_ag6kcc117jlhp4pfr.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_fuydkr116jlhp4pes.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_fuydkr116jlhp4pes.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_fgaic0yijlhp4o9q.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_fuydkr116jlhp4pes.set(element, 'max-height', absMax + 'px');
  };
  var $_6uxb3t115jlhp4pen = {
    set: set$3,
    get: get$4,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_fgaic0yijlhp4o9q.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_czfm61ynjlhp4oal.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_czfm61ynjlhp4oal.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_czfm61ynjlhp4oal.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_czfm61ynjlhp4oal.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_c9j7i8yyjlhp4oc5.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_cdb0e611ajlhp4pga.ancestors(scope, function (e) {
      return $_c9j7i8yyjlhp4oc5.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_cdb0e611ajlhp4pga.siblings(scope, function (e) {
      return $_c9j7i8yyjlhp4oc5.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_cdb0e611ajlhp4pga.children(scope, function (e) {
      return $_c9j7i8yyjlhp4oc5.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_c9j7i8yyjlhp4oc5.all(selector, scope);
  };
  var $_9sl3jr119jlhp4pg8 = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_c9j7i8yyjlhp4oc5.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_46tilw103jlhp4p1x.ancestor(scope, function (e) {
      return $_c9j7i8yyjlhp4oc5.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_46tilw103jlhp4p1x.sibling(scope, function (e) {
      return $_c9j7i8yyjlhp4oc5.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_46tilw103jlhp4p1x.child(scope, function (e) {
      return $_c9j7i8yyjlhp4oc5.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_c9j7i8yyjlhp4oc5.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_c9j7i8yyjlhp4oc5.is, ancestor$2, scope, selector, isRoot);
  };
  var $_9iep0l11bjlhp4pgg = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_9sl3jr119jlhp4pg8.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_7pgsr6zujlhp4owp.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_7pgsr6zujlhp4owp.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_7pgsr6zujlhp4owp.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_9sl3jr119jlhp4pg8.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_7pgsr6zujlhp4owp.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_9iep0l11bjlhp4pgg.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_9iep0l11bjlhp4pgg.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_7pgsr6zujlhp4owp.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_eaees2101jlhp4p1e.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_9iep0l11bjlhp4pgg.closest(element, sel);
      }).getOr(element);
      return $_6uxb3t115jlhp4pen.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_9sl3jr119jlhp4pg8.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_9iep0l11bjlhp4pgg.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_ckoxm1ytjlhp4obh.eq, tabstop));
  ...
  var inside = function (target) {
    return $_cmqrgzykjlhp4oad.name(target) === 'input' && $_fo5bp1zwjlhp4oxk.get(target, 'type') !== 'radio' || $_cmqrgzykjlhp4oad.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_fuydkr116jlhp4pes.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_6mkdrc11tjlhp4pla = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_6mkdrc11tjlhp4pla.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_6mkdrc11tjlhp4pla.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_fuydkr116jlhp4pes.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_fuydkr116jlhp4pes.set, element, property, initial);
    var on = curry($_fuydkr116jlhp4pes.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_eit6sl11vjlhp4plt.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_ckoxm1ytjlhp4obh.eq, current);
    var candidates = $_9sl3jr119jlhp4pg8.descendants(container, selector);
    var visible = filter(candidates, $_eit6sl11vjlhp4plt.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_ckoxm1ytjlhp4obh.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_9iep0l11bjlhp4pgg.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_9iep0l11bjlhp4pgg.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_9iep0l11bjlhp4pgg.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_9iep0l11bjlhp4pgg.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_9iep0l11bjlhp4pgg.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_eaees2101jlhp4p1e.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_9sl3jr119jlhp4pg8.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_9iep0l11bjlhp4pgg.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_9sl3jr119jlhp4pg8.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_9sl3jr119jlhp4pg8.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_9iep0l11bjlhp4pgg.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_a364e1zhjlhp4oh5.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_a364e1zhjlhp4oh5.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_fo5bp1zwjlhp4oxk.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_fo5bp1zwjlhp4oxk.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_cmqrgzykjlhp4oad.isElement(elem) ? $_fo5bp1zwjlhp4oxk.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_czfm61ynjlhp4oal.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_6q029v10fjlhp4p6n.get(elem) };
    return deepMerge({
      tag: $_cmqrgzykjlhp4oad.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_31z3g110tjlhp4pb2.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_31z3g110tjlhp4pb2.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_37lhgz10sjlhp4pav.format(command, function (button, status) {
  ...
  var isTouch = $_97e13cy3jlhp4o6s.detect().deviceType.isTouch();
  ...
  var platform = $_97e13cy3jlhp4o6s.detect();
  ...
  var isTouch$2 = $_97e13cy3jlhp4o6s.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_fuydkr116jlhp4pes.set(element, 'max-width', absMax + 'px');
  };
  var $_dvekxf130jlhp4q28 = {
    set: set$4,
    get: get$6,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_97e13cy3jlhp4o6s.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_dvekxf130jlhp4q28.get(thumb.element()) / 2;
      $_fuydkr116jlhp4pes.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_fuydkr116jlhp4pes.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_dca37f10ujlhp4pb7.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_fuydkr116jlhp4pes.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_31z3g110tjlhp4pb2.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_37lhgz10sjlhp4pav.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_31z3g110tjlhp4pb2.resolve('slider-' + spec$$1.category + '-size-container'),
          $_31z3g110tjlhp4pb2.resolve('slider'),
          $_31z3g110tjlhp4pb2.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_d3n81u133jlhp4q2g = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_cmqrgzykjlhp4oad.isElement(rawStart) ? Option.some(rawStart) : $_czfm61ynjlhp4oal.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_46tilw103jlhp4p1x.closest(start, function (elem) {
        return $_fuydkr116jlhp4pes.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_fuydkr116jlhp4pes.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_fuydkr116jlhp4pes.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_ckoxm1ytjlhp4obh.eq(root, e);
    };
  ...
  var $_6b8ygb134jlhp4q2w = {
    candidates: constant(candidates),
    get: get$7,
    apply: apply$1
  };

  var sizes = $_6b8ygb134jlhp4q2w.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_d3n81u133jlhp4q2g.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_6b8ygb134jlhp4q2w.apply(editor, value);
      },
      getInitialValue: function () {
        return $_6b8ygb134jlhp4q2w.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_2wizs3yvjlhp4obw.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_2wizs3yvjlhp4obw.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_2wizs3yvjlhp4obw.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_2wizs3yvjlhp4obw.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_2wizs3yvjlhp4obw.getOrDie('atob');
    return f(base64);
  };
  var $_3xdbn613fjlhp4q5p = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_3xdbn613fjlhp4q5p.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_91mfpi139jlhp4q5b.create($_6jr4tb13ajlhp4q5e.getWidth(image), $_6jr4tb13ajlhp4q5e.getHeight(image));
      context = $_91mfpi139jlhp4q5b.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_7f9pik138jlhp4q4r.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_7f9pik138jlhp4q4r.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_7f9pik138jlhp4q4r.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_7f9pik138jlhp4q4r.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_7f9pik138jlhp4q4r.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_7f9pik138jlhp4q4r.uriToBlob(uri));
  };
  var $_g7jbop137jlhp4q4l = {
  ...
  var addImage = function (editor, blob) {
    $_g7jbop137jlhp4q4l.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_b2tp7q13ijlhp4q6j.get(link);
    var url = $_fo5bp1zwjlhp4oxk.get(link, 'href');
    var title = $_fo5bp1zwjlhp4oxk.get(link, 'title');
    var target = $_fo5bp1zwjlhp4oxk.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_fo5bp1zwjlhp4oxk.get(link, 'href');
    var prevText = $_b2tp7q13ijlhp4q6j.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_fo5bp1zwjlhp4oxk.setAll(link, attrs);
        text.each(function (newText) {
          $_b2tp7q13ijlhp4q6j.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_9iep0l11bjlhp4pgg.closest(start, 'a');
  };
  var $_691s3z13hjlhp4q62 = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_97e13cy3jlhp4o6s.detect();
  ...
  var $_9iqy0413jjlhp4q6l = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_f327fj13tjlhp4qa1.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_f327fj13tjlhp4qa1.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_f327fj13tjlhp4qa1.get(input.element());
            if (current !== data) {
              $_f327fj13tjlhp4qa1.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_31z3g110tjlhp4pb2.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_cmqrgzykjlhp4oad.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_fo5bp1zwjlhp4oxk.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_fo5bp1zwjlhp4oxk.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_fo5bp1zwjlhp4oxk.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_fo5bp1zwjlhp4oxk.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_fo5bp1zwjlhp4oxk.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_fo5bp1zwjlhp4oxk.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_7pgsr6zujlhp4owp.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_7pgsr6zujlhp4owp.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_31z3g110tjlhp4pb2.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_9iep0l11bjlhp4pgg.descendant(dialog.element(), '.' + $_31z3g110tjlhp4pb2.resolve('serialised-dialog-chain')).each(function (parent) {
        $_fuydkr116jlhp4pes.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_9sl3jr119jlhp4pg8.descendants(dialog.element(), '.' + $_31z3g110tjlhp4pb2.resolve('serialised-dialog-screen'));
      $_9iep0l11bjlhp4pgg.descendant(dialog.element(), '.' + $_31z3g110tjlhp4pb2.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_fuydkr116jlhp4pes.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_dvekxf130jlhp4q28.get(screens[0]);
            $_fuydkr116jlhp4pes.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_9sl3jr119jlhp4pg8.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_37lhgz10sjlhp4pav.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_31z3g110tjlhp4pb2.resolve('dot-active'),
          itemClass: $_31z3g110tjlhp4pb2.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_9e4nvo144jlhp4qdr.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_9e4nvo144jlhp4qdr.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_9e4nvo144jlhp4qdr.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_691s3z13hjlhp4q62.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_691s3z13hjlhp4q62.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_dca37f10ujlhp4pb7.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_9iqy0413jjlhp4q6l.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_691s3z13hjlhp4q62.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_ckoxm1ytjlhp4obh.eq(originator, component.element()) && !$_ckoxm1ytjlhp4obh.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_a364e1zhjlhp4oh5.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_a364e1zhjlhp4oh5.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_a364e1zhjlhp4oh5.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_a364e1zhjlhp4oh5.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_a364e1zhjlhp4oh5.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_7pgsr6zujlhp4owp.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_7pgsr6zujlhp4owp.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_7pgsr6zujlhp4owp.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_7pgsr6zujlhp4owp.has(element, clazz);
    });
  };
  ...
  var get$10 = function (element) {
    return $_867uq6zxjlhp4ozj.supports(element) ? getNative(element) : $_867uq6zxjlhp4ozj.get(element);
  };
  var $_1kpeq314mjlhp4qnd = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_fo5bp1zwjlhp4oxk.setAll(subject, definition.attributes().getOr({}));
    $_1kpeq314mjlhp4qnd.add(subject, definition.classes().getOr([]));
    $_fuydkr116jlhp4pes.setAll(subject, definition.styles().getOr({}));
    $_6q029v10fjlhp4p6n.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_cfe7gqz0jlhp4ocp.append(subject, children);
    definition.value().each(function (value) {
      $_f327fj13tjlhp4qa1.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_czfm61ynjlhp4oal.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_a364e1zhjlhp4oh5.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_eaees2101jlhp4p1e.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_czfm61ynjlhp4oal.owner(container);
    var refocus = $_eaees2101jlhp4p1e.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_ckoxm1ytjlhp4obh.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_46tilw103jlhp4p1x.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_eaees2101jlhp4p1e.active(ownerDoc).filter(function (newFocus) {
        return $_ckoxm1ytjlhp4obh.eq(newFocus, oldFocus);
      }).fold(function () {
        $_eaees2101jlhp4p1e.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_bmvospymjlhp4oai.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_bmvospymjlhp4oai.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_ckoxm1ytjlhp4obh.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_7pgsr6zujlhp4owp.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_fgaic0yijlhp4o9q.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_1kpeq314mjlhp4qnd.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_1kpeq314mjlhp4qnd.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_9iep0l11bjlhp4pgg.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_7pgsr6zujlhp4owp.remove(comp.element(), t.transitionClass());
      $_fo5bp1zwjlhp4oxk.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_fo5bp1zwjlhp4oxk.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_fo5bp1zwjlhp4oxk.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_fo5bp1zwjlhp4oxk.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_fo5bp1zwjlhp4oxk.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_fo5bp1zwjlhp4oxk.has(comp.element(), transConfig.stateAttr()) && $_fo5bp1zwjlhp4oxk.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_fo5bp1zwjlhp4oxk.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_fo5bp1zwjlhp4oxk.has(comp.element(), transConfig.destinationAttr())) {
      $_fo5bp1zwjlhp4oxk.set(comp.element(), transConfig.stateAttr(), $_fo5bp1zwjlhp4oxk.get(comp.element(), transConfig.destinationAttr()));
      $_fo5bp1zwjlhp4oxk.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_7pgsr6zujlhp4owp.add(comp.element(), t.transitionClass());
      $_fo5bp1zwjlhp4oxk.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_fo5bp1zwjlhp4oxk.has(e, transConfig.stateAttr()) ? Option.some($_fo5bp1zwjlhp4oxk.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_31z3g110tjlhp4pb2.resolve('scrollable');
  var register = function (element) {
    $_7pgsr6zujlhp4owp.add(element, scrollable);
  };
  var deregister = function (element) {
    $_7pgsr6zujlhp4owp.remove(element, scrollable);
  };
  var $_csydjd159jlhp4qwp = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_31z3g110tjlhp4pb2.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_31z3g110tjlhp4pb2.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_37lhgz10sjlhp4pav.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_31z3g110tjlhp4pb2.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_31z3g110tjlhp4pb2.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_31z3g110tjlhp4pb2.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_fuydkr116jlhp4pes.set(component.element(), 'overflow-y', 'auto');
                $_fuydkr116jlhp4pes.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_csydjd159jlhp4qwp.register(component.element());
              }),
              runOnDetached(function (component) {
                $_fuydkr116jlhp4pes.remove(component.element(), 'overflow-y');
                $_fuydkr116jlhp4pes.remove(component.element(), '-webkit-overflow-scrolling');
                $_csydjd159jlhp4qwp.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_31z3g110tjlhp4pb2.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_dvekxf130jlhp4q28.get(container.element());
        $_dvekxf130jlhp4q28.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_dvekxf130jlhp4q28.get(container.element());
        var menu = $_9iep0l11bjlhp4pgg.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_dvekxf130jlhp4q28.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_9iep0l11bjlhp4pgg.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_31z3g110tjlhp4pb2.resolve('styles-background-menu'),
        menu: $_31z3g110tjlhp4pb2.resolve('styles-menu'),
        selectedMenu: $_31z3g110tjlhp4pb2.resolve('styles-selected-menu'),
        item: $_31z3g110tjlhp4pb2.resolve('styles-item'),
        selectedItem: $_31z3g110tjlhp4pb2.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_429dil147jlhp4qf2 = { sketch: sketch$9 };
  ...
  var $_76250x15ajlhp4qww = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_76250x15ajlhp4qww.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_429dil147jlhp4qf2.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_dca37f10ujlhp4pb7.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_dca37f10ujlhp4pb7.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_dca37f10ujlhp4pb7.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_chxfqp12kjlhp4pwz.sketch(realm, editor);
    };
    var styleFormats = $_f543xr145jlhp4qdu.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_f543xr145jlhp4qdu.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_dca37f10ujlhp4pb7.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_37lhgz10sjlhp4pav.receive($_dzhzl109jlhp4p3x.orientationChanged(), Toggling.off),
            $_37lhgz10sjlhp4pav.receive($_dzhzl109jlhp4p3x.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_cuvktc15djlhp4qxv.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_cuvktc15djlhp4qxv.capture(element, event, filter$1, handler);
  };
  var $_aaietg15cjlhp4qxq = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_97e13cy3jlhp4o6s.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_aaietg15cjlhp4qxq.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_ckoxm1ytjlhp4obh.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_aaietg15cjlhp4qxq.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_aaietg15cjlhp4qxq.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_30yiff15ijlhp4qzu = { monitor: monitor$1 };

  var isAndroid6 = $_97e13cy3jlhp4o6s.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_30yiff15ijlhp4qzu.monitor(editorApi);
    var outerDoc = $_czfm61ynjlhp4oal.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_ckoxm1ytjlhp4obh.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_eaees2101jlhp4p1e.active(outerDoc).filter(function (input) {
        return $_cmqrgzykjlhp4oad.name(input) === 'input';
    ...
    var listeners = [
      $_aaietg15cjlhp4qxq.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_aaietg15cjlhp4qxq.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_eaees2101jlhp4p1e.blur(editorApi.body());
      }),
      ...
      $_aaietg15cjlhp4qxq.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_aaietg15cjlhp4qxq.bind(outerDoc, 'select', updateMargin),
      $_aaietg15cjlhp4qxq.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_4xa23p15hjlhp4qyz = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_fo5bp1zwjlhp4oxk.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_6i4k4x15mjlhp4r2l = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_cmqrgzykjlhp4oad.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_cmqrgzykjlhp4oad.name(element) === 'img' ? 1 : $_brliho15pjlhp4r4n.getOption(element).fold(function () {
      return $_czfm61ynjlhp4oal.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_brliho15pjlhp4r4n.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_cmqrgzykjlhp4oad.name(elem));
  };
  var $_d3th8m15ojlhp4r4d = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_9q1yhz15sjlhp4r5f.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_czfm61ynjlhp4oal.defaultView(start);
  };
  var $_6ucepa15rjlhp4r53 = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_czfm61ynjlhp4oal.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_ckoxm1ytjlhp4obh.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_8i3v4v15ujlhp4r65 = {
    after: after$2,
  ...
  var $_cq4wqy15vjlhp4r6a = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_788c115wjlhp4r6m.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_788c115wjlhp4r6m.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_788c115wjlhp4r6m.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_788c115wjlhp4r6m.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_brliho15pjlhp4r4n.get(textnode).length;
    var offset = $_bwc11l160jlhp4rao.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_bwc11l160jlhp4rao.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_7z5fen161jlhp4ras = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_czfm61ynjlhp4oal.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_bwc11l160jlhp4rao.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_cmqrgzykjlhp4oad.isText(node) ? $_7z5fen161jlhp4ras.locate : searchInChildren;
  ...
  var $_arrrzv15zjlhp4r9q = { locate: locate$2 };

  var first$3 = function (element) {
    return $_46tilw103jlhp4p1x.descendant(element, $_d3th8m15ojlhp4r4d.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_d3th8m15ojlhp4r4d.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_czfm61ynjlhp4oal.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_awm6by163jlhp4rbn.first : $_awm6by163jlhp4rbn.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_czfm61ynjlhp4oal.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_236smu162jlhp4rbd = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_arrrzv15zjlhp4r9q.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_236smu162jlhp4rbd.search(doc, elem, x);
      };
      return $_czfm61ynjlhp4oal.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_6ucepa15rjlhp4r53.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_btfhf215yjlhp4r8e = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_788c115wjlhp4r6m.create(win);
    var self = $_c9j7i8yyjlhp4oc5.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_9sl3jr119jlhp4pg8.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_788c115wjlhp4r6m.selectNodeContentsUsing(innerRange, elem);
      return $_788c115wjlhp4r6m.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_8eyyi415xjlhp4r77.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_cmqrgzykjlhp4oad.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_a4zgx7164jlhp4rby = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_cmqrgzykjlhp4oad.name(element);
    if ('input' === name)
      return $_9q1yhz15sjlhp4r5f.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_9q1yhz15sjlhp4r5f.on(element, offset);
    else
      return offset === 0 ? $_9q1yhz15sjlhp4r5f.before(element) : $_9q1yhz15sjlhp4r5f.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_9q1yhz15sjlhp4r5f.before, beforeSpecial, $_9q1yhz15sjlhp4r5f.after);
    var finish = finishSitu.fold($_9q1yhz15sjlhp4r5f.before, beforeSpecial, $_9q1yhz15sjlhp4r5f.after);
    return $_6ucepa15rjlhp4r53.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_6ucepa15rjlhp4r53.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_788c115wjlhp4r6m.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_a4zgx7164jlhp4rby.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_8eyyi415xjlhp4r77.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_9v21th165jlhp4rc5.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_9v21th165jlhp4rc5.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_6ucepa15rjlhp4r53.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_788c115wjlhp4r6m.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_9v21th165jlhp4rc5.preprocess(selection);
    return $_8eyyi415xjlhp4r77.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_6ucepa15rjlhp4r53.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_8i3v4v15ujlhp4r65.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_6ucepa15rjlhp4r53.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_788c115wjlhp4r6m.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$13 = function (win) {
    return getExact(win).map(function (range) {
      return $_6ucepa15rjlhp4r53.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_8eyyi415xjlhp4r77.asLtrRange(win, selection);
    return $_788c115wjlhp4r6m.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_8eyyi415xjlhp4r77.asLtrRange(win, selection);
    return $_788c115wjlhp4r6m.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_btfhf215yjlhp4r8e.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_8eyyi415xjlhp4r77.asLtrRange(win, selection);
    return $_788c115wjlhp4r6m.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_8eyyi415xjlhp4r77.asLtrRange(win, selection);
    return $_788c115wjlhp4r6m.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_8eyyi415xjlhp4r77.asLtrRange(win, selection);
    var fragment = $_cq4wqy15vjlhp4r6a.fromElements(elements, win.document);
    $_788c115wjlhp4r6m.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_8eyyi415xjlhp4r77.asLtrRange(win, selection);
    $_788c115wjlhp4r6m.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_ckoxm1ytjlhp4obh.eq(start, finish) && soffset === foffset;
  };
  var $_jkhsc15tjlhp4r5t = {
    setExact: setExact,
    getExact: getExact,
    get: get$13,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_czfm61ynjlhp4oal.parent(start_1).bind(function (parent) {
        var selection = $_6ucepa15rjlhp4r53.exact(start_1, range$$1.startOffset, parent, $_d3th8m15ojlhp4r4d.getEnd(parent));
        var optRect = $_jkhsc15tjlhp4r5t.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_era80n15njlhp4r2z = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_eaees2101jlhp4p1e.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_cmqrgzykjlhp4oad.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_eaees2101jlhp4p1e.active().each($_eaees2101jlhp4p1e.blur);
      $_eaees2101jlhp4p1e.focus(iBody);
    });
  };
  var $_7wk1dj166jlhp4rch = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_31z3g110tjlhp4pb2.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_fo5bp1zwjlhp4oxk.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_6i4k4x15mjlhp4r2l.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_era80n15njlhp4r2z.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_7wk1dj166jlhp4rch.resume(cWin);
    };
    var onResize = $_aaietg15cjlhp4qxq.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_17ary015ljlhp4r1u = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_jkhsc15tjlhp4r5t.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_aaietg15cjlhp4qxq.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_jkhsc15tjlhp4r5t.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_jkhsc15tjlhp4r5t.get(win).bind(function (sel) {
                return $_jkhsc15tjlhp4r5t.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_jkhsc15tjlhp4r5t.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_jkhsc15tjlhp4r5t.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_97e13cy3jlhp4o6s.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_fuydkr116jlhp4pes.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_9sl3jr119jlhp4pg8.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_fo5bp1zwjlhp4oxk.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_fo5bp1zwjlhp4oxk.set(element, attr, backup);
          $_fo5bp1zwjlhp4oxk.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_9sl3jr119jlhp4pg8.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_9sl3jr119jlhp4pg8.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_fo5bp1zwjlhp4oxk.get(element, attr);
      if (restore !== 'no-styles') {
        $_fo5bp1zwjlhp4oxk.set(element, 'style', restore);
      } else {
        $_fo5bp1zwjlhp4oxk.remove(element, 'style');
      }
      $_fo5bp1zwjlhp4oxk.remove(element, attr);
  ...
  var $_8pkisx168jlhp4re9 = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_9iep0l11bjlhp4pgg.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_fo5bp1zwjlhp4oxk.set(meta, 'name', 'viewport');
      $_bmvospymjlhp4oai.append(head, meta);
      return meta;
    };
    var element = $_9iep0l11bjlhp4pgg.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_fo5bp1zwjlhp4oxk.get(element, 'content');
    var maximize = function () {
      $_fo5bp1zwjlhp4oxk.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_fo5bp1zwjlhp4oxk.set(element, 'content', backup);
      } else {
        $_fo5bp1zwjlhp4oxk.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_ekv40n169jlhp4rer = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_ekv40n169jlhp4rer.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_7pgsr6zujlhp4owp.add(platform.container, $_31z3g110tjlhp4pb2.resolve('fullscreen-maximized'));
      $_7pgsr6zujlhp4owp.add(platform.container, $_31z3g110tjlhp4pb2.resolve('android-maximized'));
      meta.maximize();
      $_7pgsr6zujlhp4owp.add(platform.body, $_31z3g110tjlhp4pb2.resolve('android-scroll-reload'));
      androidApi.set($_17ary015ljlhp4r1u.setup(platform.win, $_cyia11167jlhp4rdb.getWin(platform.editor).getOrDie('no')));
      $_cyia11167jlhp4rdb.getActiveApi(platform.editor).each(function (editorApi) {
        $_8pkisx168jlhp4re9.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_4xa23p15hjlhp4qyz.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_7pgsr6zujlhp4owp.remove(platform.container, $_31z3g110tjlhp4pb2.resolve('fullscreen-maximized'));
      $_7pgsr6zujlhp4owp.remove(platform.container, $_31z3g110tjlhp4pb2.resolve('android-maximized'));
      $_8pkisx168jlhp4re9.restoreStyles();
      $_7pgsr6zujlhp4owp.remove(platform.body, $_31z3g110tjlhp4pb2.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_51wnpj15gjlhp4qyr = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_31z3g110tjlhp4pb2.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_31z3g110tjlhp4pb2.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_99cajl16ajlhp4rf7 = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_czfm61ynjlhp4oal.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_fuydkr116jlhp4pes.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_99cajl16ajlhp4rf7.sketch(onTap, mobile.translate));
    ...
    $_bmvospymjlhp4oai.append(mobile.container, mask.element());
    var mode = $_51wnpj15gjlhp4qyr.create(mobile, maskApi);
    return {
  ...
  var $_57aweo15fjlhp4qyc = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_31z3g110tjlhp4pb2.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_fo5bp1zwjlhp4oxk.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_fo5bp1zwjlhp4oxk.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_aaietg15cjlhp4qxq.bind(scope, 'touchmove', function (event) {
      $_9iep0l11bjlhp4pgg.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_b8pn6b16ijlhp4rj1 = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_fuydkr116jlhp4pes.set(component.element(), 'overflow-x', 'auto');
              $_b8pn6b16ijlhp4rj1.markAsHorizontal(component.element());
              $_csydjd159jlhp4qwp.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_31z3g110tjlhp4pb2.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_31z3g110tjlhp4pb2.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_31z3g110tjlhp4pb2.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_31z3g110tjlhp4pb2.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_1kpeq314mjlhp4qnd.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_7pgsr6zujlhp4owp.remove(component.element(), slideConfig.openClass());
    $_7pgsr6zujlhp4owp.add(component.element(), slideConfig.closedClass());
    $_fuydkr116jlhp4pes.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_fuydkr116jlhp4pes.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_7pgsr6zujlhp4owp.remove(component.element(), slideConfig.closedClass());
    $_7pgsr6zujlhp4owp.add(component.element(), slideConfig.openClass());
    $_fuydkr116jlhp4pes.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_fuydkr116jlhp4pes.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_fuydkr116jlhp4pes.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_fuydkr116jlhp4pes.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_7pgsr6zujlhp4owp.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_7pgsr6zujlhp4owp.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_fuydkr116jlhp4pes.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_7pgsr6zujlhp4owp.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_7pgsr6zujlhp4owp.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_fuydkr116jlhp4pes.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_dvekxf130jlhp4q28.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_6uxb3t115jlhp4pen.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_31z3g110tjlhp4pb2.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_31z3g110tjlhp4pb2.resolve('dropup-closed'),
          openClass: $_31z3g110tjlhp4pb2.resolve('dropup-open'),
          shrinkingClass: $_31z3g110tjlhp4pb2.resolve('dropup-shrinking'),
          growingClass: $_31z3g110tjlhp4pb2.resolve('dropup-growing'),
        ...
        $_37lhgz10sjlhp4pav.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_cmqrgzykjlhp4oad.name(event$$1.target()));
  };
  var isFirefox = $_97e13cy3jlhp4o6s.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_aaietg15cjlhp4qxq.capture(container, 'focus', handler);
    } else {
      return $_aaietg15cjlhp4qxq.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_aaietg15cjlhp4qxq.capture(container, 'blur', handler);
    } else {
      return $_aaietg15cjlhp4qxq.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_97e13cy3jlhp4o6s.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_aaietg15cjlhp4qxq.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_aaietg15cjlhp4qxq.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_czfm61ynjlhp4oal.defaultView(container);
    var onWindowScroll = $_aaietg15cjlhp4qxq.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_czfm61ynjlhp4oal.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_46tilw103jlhp4p1x.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_fgaic0yijlhp4o9q.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_czfm61ynjlhp4oal.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_ckoxm1ytjlhp4obh.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_eaees2101jlhp4p1e.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_cmqrgzykjlhp4oad.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_alqyuxyzjlhp4ocj.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_31z3g110tjlhp4pb2.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_31z3g110tjlhp4pb2.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_31z3g110tjlhp4pb2.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_31z3g110tjlhp4pb2.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_aozmb716jjlhp4rje.makeEditSwitch(webapp);
    var socket = $_aozmb716jjlhp4rje.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_57aweo15fjlhp4qyc.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_aozmb716jjlhp4rje.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_fuydkr116jlhp4pes.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_bmvospymjlhp4oai.append(parent, input);
    $_eaees2101jlhp4p1e.focus(input);
    operation(input);
    $_alqyuxyzjlhp4ocj.remove(input);
  };
  var $_cpz2y3173jlhp4rrw = { input: input$1 };
  ...
  var $_4z1jg175jlhp4rsm = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_eaees2101jlhp4p1e.active().each(function (active) {
      if (!$_ckoxm1ytjlhp4obh.eq(active, frame)) {
        $_eaees2101jlhp4p1e.blur(active);
      }
    });
    cWin.focus();
    $_eaees2101jlhp4p1e.focus(Element$$1.fromDom(cWin.document.body));
    $_4z1jg175jlhp4rsm.refresh(cWin);
  };
  var $_254qym174jlhp4rsc = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_254qym174jlhp4rsc.resume(cWin, frame);
    };
    var toReading = function () {
      $_cpz2y3173jlhp4rrw.input(outerBody, $_eaees2101jlhp4p1e.blur);
    };
    var captureInput = $_aaietg15cjlhp4qxq.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_cmqrgzykjlhp4oad.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_6uxb3t115jlhp4pen.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_aaietg15cjlhp4qxq.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_ckoxm1ytjlhp4obh.eq(editorApi.html(), touchEvent.target()) || $_ckoxm1ytjlhp4obh.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_aaietg15cjlhp4qxq.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_aaietg15cjlhp4qxq.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_aaietg15cjlhp4qxq.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_aaietg15cjlhp4qxq.bind(toolstrip, 'touchmove', function () {
  ...
  var $_3ih7mp176jlhp4rsu = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_7pgsr6zujlhp4owp.add(container, $_31z3g110tjlhp4pb2.resolve('unfocused-selections'));
    $_bmvospymjlhp4oai.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_aaietg15cjlhp4qxq.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_254qym174jlhp4rsc.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_1kpeq314mjlhp4qnd.add(span, [
        $_31z3g110tjlhp4pb2.resolve('layer-editor'),
        $_31z3g110tjlhp4pb2.resolve('unfocused-selection')
      ]);
      $_fuydkr116jlhp4pes.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_era80n15njlhp4r2z.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_cfe7gqz0jlhp4ocp.append(container, spans);
    };
    var clear = function () {
      $_alqyuxyzjlhp4ocj.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_alqyuxyzjlhp4ocj.remove(container);
    };
    var isActive = function () {
      return $_czfm61ynjlhp4oal.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_82t0gb17gjlhp4rwv = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_82t0gb17gjlhp4rwv.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_6922i015bjlhp4qxa.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_czfm61ynjlhp4oal.owner(socket).dom().defaultView;
    var viewportHeight = $_6uxb3t115jlhp4pen.get(socket) + $_6uxb3t115jlhp4pen.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_6uxb3t115jlhp4pen.get(socket) + $_6uxb3t115jlhp4pen.get(dropup) - greenzoneHeight;
    $_fuydkr116jlhp4pes.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_dzju5p17fjlhp4rwk = {
  ...
  var yFixedData = 'data-' + $_31z3g110tjlhp4pb2.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_31z3g110tjlhp4pb2.resolve('y-property');
  var yScrollingData = 'data-' + $_31z3g110tjlhp4pb2.resolve('scrolling');
  var windowSizeData = 'data-' + $_31z3g110tjlhp4pb2.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_6i4k4x15mjlhp4r2l.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_fo5bp1zwjlhp4oxk.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_6i4k4x15mjlhp4r2l.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_fo5bp1zwjlhp4oxk.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_9sl3jr119jlhp4pg8.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_fo5bp1zwjlhp4oxk.get(toolbar, 'style');
    $_fuydkr116jlhp4pes.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_fo5bp1zwjlhp4oxk.set(toolbar, yFixedData, '0px');
    $_fo5bp1zwjlhp4oxk.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_fo5bp1zwjlhp4oxk.set(toolbar, 'style', oldToolbarStyle || '');
      $_fo5bp1zwjlhp4oxk.remove(toolbar, yFixedData);
      $_fo5bp1zwjlhp4oxk.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_fo5bp1zwjlhp4oxk.get(viewport, 'style');
    $_csydjd159jlhp4qwp.register(viewport);
    $_fuydkr116jlhp4pes.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_fo5bp1zwjlhp4oxk.set(viewport, yFixedData, toolbarHeight + 'px');
    $_fo5bp1zwjlhp4oxk.set(viewport, yScrollingData, 'true');
    $_fo5bp1zwjlhp4oxk.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_csydjd159jlhp4qwp.deregister(viewport);
      $_fo5bp1zwjlhp4oxk.set(viewport, 'style', oldViewportStyle || '');
      $_fo5bp1zwjlhp4oxk.remove(viewport, yFixedData);
      $_fo5bp1zwjlhp4oxk.remove(viewport, yScrollingData);
      $_fo5bp1zwjlhp4oxk.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_fo5bp1zwjlhp4oxk.get(dropup, 'style');
    $_fuydkr116jlhp4pes.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_fo5bp1zwjlhp4oxk.set(dropup, yFixedData, '0px');
    $_fo5bp1zwjlhp4oxk.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_fo5bp1zwjlhp4oxk.set(dropup, 'style', oldDropupStyle || '');
      $_fo5bp1zwjlhp4oxk.remove(dropup, yFixedData);
      $_fo5bp1zwjlhp4oxk.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_czfm61ynjlhp4oal.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_fo5bp1zwjlhp4oxk.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_czfm61ynjlhp4oal.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_6uxb3t115jlhp4pen.get(toolbar);
    var dropupHeight = $_6uxb3t115jlhp4pen.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_6uxb3t115jlhp4pen.get(toolbar);
        var dropupHeight_1 = $_6uxb3t115jlhp4pen.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_fo5bp1zwjlhp4oxk.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_fuydkr116jlhp4pes.set(viewport, 'height', newHeight + 'px');
        $_fuydkr116jlhp4pes.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_dzju5p17fjlhp4rwk.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_fo5bp1zwjlhp4oxk.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_dzju5p17fjlhp4rwk.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_m1h3p17ejlhp4rvv = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_485jth17djlhp4rvo.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_31z3g110tjlhp4pb2.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_fuydkr116jlhp4pes.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_fuydkr116jlhp4pes.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_fuydkr116jlhp4pes.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_fo5bp1zwjlhp4oxk.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_6i4k4x15mjlhp4r2l.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_fo5bp1zwjlhp4oxk.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_fo5bp1zwjlhp4oxk.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_fuydkr116jlhp4pes.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_m1h3p17ejlhp4rvv.getYFixedData(element) + 'px';
    $_fuydkr116jlhp4pes.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_czfm61ynjlhp4oal.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_dzju5p17fjlhp4rwk.getGreenzone(socket, dropup);
    var refreshCursor = curry($_4z1jg175jlhp4rsm.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_3gy9q6179jlhp4ruv.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_3gy9q6179jlhp4ruv.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_dm4amb17ijlhp4rxe = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_fuydkr116jlhp4pes.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_fuydkr116jlhp4pes.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_3gy9q6179jlhp4ruv.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_7kknqt17jjlhp4rxj.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_aaietg15cjlhp4qxq.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_7kknqt17jjlhp4rxj.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_m1h3p17ejlhp4rvv.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_fgaic0yijlhp4o9q.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_6922i015bjlhp4qxa.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_dm4amb17ijlhp4rxe.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_fuydkr116jlhp4pes.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_3gy9q6179jlhp4ruv.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_cpz2y3173jlhp4rrw.input($_fgaic0yijlhp4o9q.body(), $_eaees2101jlhp4p1e.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_1cvwrw177jlhp4rtb = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_cyia11167jlhp4rdb.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_fuydkr116jlhp4pes.getRaw(platform.socket, 'height'),
          iframeHeight: $_fuydkr116jlhp4pes.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_b8pn6b16ijlhp4rj1.exclusive(doc, '.' + $_csydjd159jlhp4qwp.scrollable()) });
        $_7pgsr6zujlhp4owp.add(platform.container, $_31z3g110tjlhp4pb2.resolve('fullscreen-maximized'));
        $_8pkisx168jlhp4re9.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_fuydkr116jlhp4pes.set(platform.socket, 'overflow', 'scroll');
        $_fuydkr116jlhp4pes.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_eaees2101jlhp4p1e.focus(editorApi.body());
        ...
        iosApi.set($_1cvwrw177jlhp4rtb.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_5wor1h172jlhp4rrh.stubborn,
        ...
        iosEvents.set($_3ih7mp176jlhp4rsu.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_fuydkr116jlhp4pes.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_fuydkr116jlhp4pes.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_7pgsr6zujlhp4owp.remove(platform.container, $_31z3g110tjlhp4pb2.resolve('fullscreen-maximized'));
      $_8pkisx168jlhp4re9.restoreStyles();
      $_csydjd159jlhp4qwp.deregister(platform.toolbar);
      $_fuydkr116jlhp4pes.remove(platform.socket, 'overflow');
      $_fuydkr116jlhp4pes.remove(platform.socket, '-webkit-overflow-scrolling');
      $_eaees2101jlhp4p1e.blur(platform.editor.getFrame());
      $_cyia11167jlhp4rdb.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_2jk3vi171jlhp4rqw = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_fuydkr116jlhp4pes.set(mobile.toolstrip, 'width', '100%');
    $_fuydkr116jlhp4pes.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_99cajl16ajlhp4rf7.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_2jk3vi171jlhp4rqw.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_6v58re170jlhp4rqj = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_31z3g110tjlhp4pb2.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_aozmb716jjlhp4rje.makeEditSwitch(webapp);
    var socket = $_aozmb716jjlhp4rje.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_6v58re170jlhp4rqj.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_bwzq9g17mjlhp4ry3 = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_dzhzl109jlhp4p3x.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_3gzidk17pjlhp4ryg = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_bwzq9g17mjlhp4ry3.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_3gzidk17pjlhp4ryg.fireSkinLoaded(editor));
      } else {
        $_3gzidk17pjlhp4ryg.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_97e13cy3jlhp4o6s.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_bmvospymjlhp4oai.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_eaees2101jlhp4p1e.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_6922i015bjlhp4qxa.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_dzhzl109jlhp4p3x.orientationChanged()], { width: $_6922i015bjlhp4qxa.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_31z3g110tjlhp4pb2.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_cmqrgzykjlhp4oad.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_cmqrgzykjlhp4oad.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_9ehpmy107jlhp4p3g.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_31z3g110tjlhp4pb2.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_31z3g110tjlhp4pb2.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_dzhzl109jlhp4p3x.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_dca37f10ujlhp4pb7.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_dca37f10ujlhp4pb7.forToolbar('readonly-back', function () {
        ...
        var features = $_eclw6g10ajlhp4p48.setup(realm, editor);
        var items = $_eclw6g10ajlhp4p48.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_6n50jn17ojlhp4ry7.init(realm, editor);
      });
      return {

...
var inlite = (function () {
  ...
  var $_1jr4017xjlhp4t6t = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_g8qmm5181jlhp4t76.fromClientRect(clientRect)) : null;
  };
  var $_6cvza4180jlhp4t72 = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_8g7ie117zjlhp4t6z.result(predicateIds[i].id, $_6cvza4180jlhp4t72.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_8g7ie117zjlhp4t6z.result(predicateIds[x].id, $_6cvza4180jlhp4t72.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_8g7ie117zjlhp4t6z.result(id, $_6cvza4180jlhp4t72.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_8g7ie117zjlhp4t6z.result(id, $_6cvza4180jlhp4t72.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_8tgsa818ajlhp4t7s.isArray(value)) {
      return value;
    } else if ($_8tgsa818ajlhp4t7s.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_8tgsa818ajlhp4t7s.isBoolean(value)) {
  ...
  var $_71aqd5189jlhp4t7p = {
    getStringOr: getByTypeOr($_8tgsa818ajlhp4t7s.isString),
    getBoolOr: getByTypeOr($_8tgsa818ajlhp4t7s.isBoolean),
    getNumberOr: getByTypeOr($_8tgsa818ajlhp4t7s.isNumber),
    getHandlerOr: getByTypeOr($_8tgsa818ajlhp4t7s.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_8tgsa818ajlhp4t7s.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_g8qmm5181jlhp4t76.toClientRect(targetRect),
        contentAreaRect: $_g8qmm5181jlhp4t76.toClientRect(contentAreaRect),
        panelRect: $_g8qmm5181jlhp4t76.toClientRect(panelRect)
      });
      return $_g8qmm5181jlhp4t76.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_71aqd5189jlhp4t7p.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_71aqd5189jlhp4t7p.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_71aqd5189jlhp4t7p.getHandlerOr(editor, 'inline_toolbar_position_handler', $_3qveyi18bjlhp4t7w.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_78tchi186jlhp4t7i.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_qwfzp187jlhp4t7l.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_qwfzp187jlhp4t7l.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_9e610y185jlhp4t7e = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_1jr4017xjlhp4t6t.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_bdewmj182jlhp4t78.fromContextToolbars(toolbars);
    result = $_8g7ie117zjlhp4t6z.match(editor, [
      $_6oqico17yjlhp4t6v.element(elements[0], contextToolbarsPredicateIds),
      $_a9ielf184jlhp4t7b.textSelection('text'),
      $_a9ielf184jlhp4t7b.emptyTextBlock(elements, 'insert'),
      $_6oqico17yjlhp4t6v.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_8g7ie117zjlhp4t6z.match(editor, [$_a9ielf184jlhp4t7b.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_9e610y185jlhp4t7e.load(editor, function () {
  ...
  var $_3x6d2917tjlhp4t6i = { renderUI: renderUI };
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_24lhiz18pjlhp4tau.parseBox(settings.border);
      self$$1.paddingBox = $_24lhiz18pjlhp4tau.parseBox(settings.padding);
      self$$1.marginBox = $_24lhiz18pjlhp4tau.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_50j9ko18xjlhp4tc9.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_24lhiz18pjlhp4tau.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_24lhiz18pjlhp4tau.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_24lhiz18pjlhp4tau.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_60gj0a18wjlhp4tc5.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_50j9ko18xjlhp4tc9.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_50j9ko18xjlhp4tc9.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_6fwax418yjlhp4tcf = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_50j9ko18xjlhp4tc9.getUiContainer(self$$1);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_50j9ko18xjlhp4tc9.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_24lhiz18pjlhp4tau.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_24lhiz18pjlhp4tau.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_3x6d2917tjlhp4t6i.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_fywpzr17sjlhp4t6e = { get: get };
  ...
  var $_eqn97s19gjlhp4tf3 = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_eqn97s19gjlhp4tf3.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_1017u219ejlhp4tex = { blobToBase64: blobToBase64 };
  ...
  var $_5dvlyv19kjlhp4tfd = { pickFile: pickFile };
  ...
  var $_f7kxi419mjlhp4tfy = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_7cm1ob19ojlhp4tg6.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_7cm1ob19ojlhp4tg6.resolve(dom, bookmark));
  };
  ...
  var $_5th2u419njlhp4tg1 = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_f7kxi419mjlhp4tfy.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_5th2u419njlhp4tg1.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_44f97919ljlhp4tfq.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_5dvlyv19kjlhp4tfd.pickFile().then(function (files) {
          var blob = files[0];
          $_1017u219ejlhp4tex.blobToBase64(blob).then(function (base64) {
            $_44f97919ljlhp4tfq.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_44f97919ljlhp4tfq.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_6kbewb19djlhp4teu = { addToEditor: addToEditor };
  ...
  var $_82nwd719sjlhp4tgt = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_7umpin19ujlhp4th2.isAbsolute(href) && $_7umpin19ujlhp4th2.isDomainLike(href) ? askAboutPrefix(editor, href) : global$12.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_44f97919ljlhp4tfq.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_44f97919ljlhp4tfq.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_c1a7319tjlhp4tgz = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_8tgsa818ajlhp4t7s.isArray(items)) {
      return items;
    } else if ($_8tgsa818ajlhp4t7s.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_8tgsa818ajlhp4t7s.isFunction(button)) {
            button = button();
          }
  ...
  var $_c2uuc719vjlhp4th5 = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_c2uuc719vjlhp4th5.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_c2uuc719vjlhp4th5.create(editor, 'text', $_qwfzp187jlhp4t7l.getTextSelectionToolbarItems(editor)),
        $_c2uuc719vjlhp4th5.create(editor, 'insert', $_qwfzp187jlhp4t7l.getInsertToolbarItems(editor)),
        $_c1a7319tjlhp4tgz.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_qwfzp187jlhp4t7l.getPositionHandler(editor);
      contentAreaRect = $_6cvza4180jlhp4t72.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_3qveyi18bjlhp4t7w.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_3qveyi18bjlhp4t7w.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_82nwd719sjlhp4tgt.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_3qveyi18bjlhp4t7w.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_6cvza4180jlhp4t72.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_3qveyi18bjlhp4t7w.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_3qveyi18bjlhp4t7w.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_78tchi186jlhp4t7i.fireBeforeRenderUI(editor);
  ...
  var isComment = function (element) {
    return type(element) === $_ezn4s81apjlhp4tla.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_ezn4s81apjlhp4tla.ELEMENT);
  var isText = isType$2($_ezn4s81apjlhp4tla.TEXT);
  var isDocument = isType$2($_ezn4s81apjlhp4tla.DOCUMENT);
  var $_ao7jjg1aojlhp4tkz = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_ao7jjg1aojlhp4tkz.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_cxe6p51awjlhp4tm8 = { toArray: toArray };

  var node = function () {
    var f = $_eqn97s19gjlhp4tf3.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_5upsf91b2jlhp4tn5.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_5upsf91b2jlhp4tn5.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_5upsf91b2jlhp4tn5.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_b8fnn01b6jlhp4tnv = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_b8fnn01b6jlhp4tnv.browsers();
    var oses = $_b8fnn01b6jlhp4tnv.oses();
    var browser = $_22rvio1b5jlhp4tnj.detectBrowser(browsers, userAgent).fold($_68yy5r1b1jlhp4tn0.unknown, $_68yy5r1b1jlhp4tn0.nu);
    var os = $_22rvio1b5jlhp4tnj.detectOs(oses, userAgent).fold($_9h3evh1b3jlhp4tn8.unknown, $_9h3evh1b3jlhp4tn8.nu);
  ...
  var $_g2seub1b0jlhp4tmy = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_g2seub1b0jlhp4tmy.detect(userAgent);
  });
  var $_d4s2o81azjlhp4tmq = { detect: detect$3 };

  var ELEMENT = $_ezn4s81apjlhp4tla.ELEMENT;
  var DOCUMENT = $_ezn4s81apjlhp4tla.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_8u3g7t1ayjlhp4tmo.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_d4s2o81azjlhp4tmq.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_a5ubbd1axjlhp4tma = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_cvyzs41bajlhp4toa.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_a5ubbd1axjlhp4tma.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_a5ubbd1axjlhp4tma.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_cxe6p51awjlhp4tm8.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_cxe6p51awjlhp4tm8.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_evejpf1amjlhp4tkr.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_84qa5g1aqjlhp4tle.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_84qa5g1aqjlhp4tle.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_84qa5g1aqjlhp4tle.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_84qa5g1aqjlhp4tle.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_cvyzs41bajlhp4toa.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_8u5zy71aljlhp4tkm.ancestors(scope, function (e) {
      return $_cvyzs41bajlhp4toa.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_8u5zy71aljlhp4tkm.siblings(scope, function (e) {
      return $_cvyzs41bajlhp4toa.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_8u5zy71aljlhp4tkm.children(scope, function (e) {
      return $_cvyzs41bajlhp4toa.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_cvyzs41bajlhp4toa.all(selector, scope);
  };
  var $_collm61akjlhp4tkk = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_collm61akjlhp4tkk.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_6pamfu1ahjlhp4tjr = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_6pamfu1ahjlhp4tjr.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_evejpf1amjlhp4tkr.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_a5ubbd1axjlhp4tma.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_cvyzs41bajlhp4toa.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_6twbkp1bgjlhp4tp5.ancestor(scope, function (e) {
      return $_cvyzs41bajlhp4toa.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_6twbkp1bgjlhp4tp5.sibling(scope, function (e) {
      return $_cvyzs41bajlhp4toa.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_6twbkp1bgjlhp4tp5.child(scope, function (e) {
      return $_cvyzs41bajlhp4toa.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_cvyzs41bajlhp4toa.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_cvyzs41bajlhp4toa.is, ancestor$1, scope, selector, isRoot);
  };
  var $_c4c2h31bfjlhp4tp2 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_212wmi1bijlhp4tps = { register: register };
  ...
  var $_eiwzl81bkjlhp4tpx = { register: register$1 };
  ...
  var $_dzzkgm1bljlhp4tq5 = { register: register$2 };
  ...
  var $_3hnpkq1bmjlhp4tq9 = { register: register$3 };
  ...
  var $_7uk8251bnjlhp4tqf = { register: register$4 };
  ...
  var $_6v8prw1bojlhp4tqj = { register: register$5 };
  ...
  var $_2dvy0o1bpjlhp4tqp = { register: register$6 };
  ...
  var $_208njq1bqjlhp4tqs = { register: register$7 };
  ...
  var $_eqntny1brjlhp4tqv = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_c4c2h31bfjlhp4tp2.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_7uk8251bnjlhp4tqf.register(editor);
    $_212wmi1bijlhp4tps.register(editor);
    $_2dvy0o1bpjlhp4tqp.register(editor);
    $_208njq1bqjlhp4tqs.register(editor);
    $_dzzkgm1bljlhp4tq5.register(editor);
    $_eiwzl81bkjlhp4tpx.register(editor);
    $_3hnpkq1bmjlhp4tq9.register(editor);
    $_eqntny1brjlhp4tqv.register(editor);
    $_6v8prw1bojlhp4tqj.register(editor);
  };
  var $_b0q55j1bejlhp4tov = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_60gj0a18wjlhp4tc5,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_3irinl19ajlhp4teg,
      Panel: Panel,
      Movable: $_6fwax418yjlhp4tcf,
      Resizable: $_3m6kn419bjlhp4tek,
      ...
      FormatControls: $_b0q55j1bejlhp4tov,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_b0q55j1bejlhp4tov.setup(editor);
    $_6kbewb19djlhp4teu.addToEditor(editor, panel);
    return $_fywpzr17sjlhp4t6e.get(editor, panel);
  });
  function Theme () {
  }

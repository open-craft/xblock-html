...
var modern = (function () {
  ...
  var $_4rtr54u0jlhp4mnz = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_od4e5u4jlhp4mod.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_od4e5u4jlhp4mod.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_7bmd52u7jlhp4mox.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_od4e5u4jlhp4mod.setUiContainer(editor, panel);
  ...
  var $_9rhyy1u1jlhp4mo2 = { addContextualToolbars: addContextualToolbars };
  ...
  var $_9hr9aau8jlhp4mp1 = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_k2ncetzjlhp4mnx.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_c9ira4ubjlhp4mpi = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_k2ncetzjlhp4mnx.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_e73d2tuejlhp4mq0 = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_4lbw52ucjlhp4mpv.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_e73d2tuejlhp4mq0.fireSkinLoaded(editor));
    } else {
      $_e73d2tuejlhp4mq0.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_9hr9aau8jlhp4mp1.createMenuButtons(editor)
            },
            $_7bmd52u7jlhp4mox.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_4lbw52ucjlhp4mpv.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_od4e5u4jlhp4mod.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_c9ira4ubjlhp4mpi.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_c9ira4ubjlhp4mpi.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_k2ncetzjlhp4mnx.fireBeforeRenderUI(editor);
    ...
    $_4rtr54u0jlhp4mnz.addKeys(editor, panel);
    $_9rhyy1u1jlhp4mo2.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_5lur6ptvjlhp4mnr = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_od4e5u4jlhp4mod.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_od4e5u4jlhp4mod.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_8ut9ieukjlhp4mrb = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_od4e5u4jlhp4mod.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_8hdqysuqjlhp4mt8.parseBox(settings.border);
      self$$1.paddingBox = $_8hdqysuqjlhp4mt8.parseBox(settings.padding);
      self$$1.marginBox = $_8hdqysuqjlhp4mt8.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_od4e5u4jlhp4mod.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_8hdqysuqjlhp4mt8.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_8hdqysuqjlhp4mt8.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_8hdqysuqjlhp4mt8.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_e73d2tuejlhp4mq0.fireSkinLoaded(editor));
    } else {
      $_e73d2tuejlhp4mq0.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_an0j01ufjlhp4mq3 = { render: render$1 };
  ...
  var $_a0ym6qv2jlhp4mvy = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_a0ym6qv2jlhp4mvy.setup(editor, theme);
    return isInline(editor) ? $_an0j01ufjlhp4mq3.render(editor, theme, args) : $_5lur6ptvjlhp4mnr.render(editor, theme, args);
  };
  var $_7cst2vtrjlhp4mni = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_8ut9ieukjlhp4mrb],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_od4e5u4jlhp4mod.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_8hdqysuqjlhp4mt8.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_8hdqysuqjlhp4mt8.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_7cst2vtrjlhp4mni.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_c9ira4ubjlhp4mpi.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_c9ira4ubjlhp4mpi.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_6gbxezw5jlhp4n5u.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_6gbxezw5jlhp4n5u.ELEMENT);
  var isText = isType$1($_6gbxezw5jlhp4n5u.TEXT);
  var isDocument = isType$1($_6gbxezw5jlhp4n5u.DOCUMENT);
  var $_eczha1w4jlhp4n5r = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_eczha1w4jlhp4n5r.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_3wrmgwwcjlhp4n7v = { toArray: toArray };
  ...
  var $_8qy1kkwfjlhp4n8j = { getOrDie: getOrDie };

  var node = function () {
    var f = $_8qy1kkwfjlhp4n8j.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_6qgrv3wljlhp4n9j.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_6qgrv3wljlhp4n9j.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_6qgrv3wljlhp4n9j.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_9ma6gvwpjlhp4na5 = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_9ma6gvwpjlhp4na5.browsers();
    var oses = $_9ma6gvwpjlhp4na5.oses();
    var browser = $_fx8ffuwojlhp4n9x.detectBrowser(browsers, userAgent).fold($_cj4699wkjlhp4n9c.unknown, $_cj4699wkjlhp4n9c.nu);
    var os = $_fx8ffuwojlhp4n9x.detectOs(oses, userAgent).fold($_1fs72wwmjlhp4n9m.unknown, $_1fs72wwmjlhp4n9m.nu);
  ...
  var $_a83n0iwjjlhp4n97 = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_a83n0iwjjlhp4n97.detect(userAgent);
  });
  var $_6uztjcwijlhp4n8v = { detect: detect$3 };

  var ELEMENT = $_6gbxezw5jlhp4n5u.ELEMENT;
  var DOCUMENT = $_6gbxezw5jlhp4n5u.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_7o94hpwejlhp4n8g.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_6uztjcwijlhp4n8v.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_7nienuwdjlhp4n7x = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_dum3pewtjlhp4nao.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_7nienuwdjlhp4n7x.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_7nienuwdjlhp4n7x.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_3wrmgwwcjlhp4n7v.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_3wrmgwwcjlhp4n7v.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_75cbuqw2jlhp4n5g.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_62heyw6jlhp4n63.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_62heyw6jlhp4n63.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_62heyw6jlhp4n63.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_62heyw6jlhp4n63.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_dum3pewtjlhp4nao.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_ge4wgkw1jlhp4n3r.ancestors(scope, function (e) {
      return $_dum3pewtjlhp4nao.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_ge4wgkw1jlhp4n3r.siblings(scope, function (e) {
      return $_dum3pewtjlhp4nao.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_ge4wgkw1jlhp4n3r.children(scope, function (e) {
      return $_dum3pewtjlhp4nao.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_dum3pewtjlhp4nao.all(selector, scope);
  };
  var $_6pc49lw0jlhp4n32 = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_6pc49lw0jlhp4n32.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_fio6qsvxjlhp4n1v = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_fio6qsvxjlhp4n1v.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_75cbuqw2jlhp4n5g.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_7nienuwdjlhp4n7x.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_dum3pewtjlhp4nao.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_3h2t9mwzjlhp4nbr.ancestor(scope, function (e) {
      return $_dum3pewtjlhp4nao.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_3h2t9mwzjlhp4nbr.sibling(scope, function (e) {
      return $_dum3pewtjlhp4nao.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_3h2t9mwzjlhp4nbr.child(scope, function (e) {
      return $_dum3pewtjlhp4nao.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_dum3pewtjlhp4nao.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_dum3pewtjlhp4nao.is, ancestor$1, scope, selector, isRoot);
  };
  var $_gi1waywyjlhp4nbp = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_4f2cvax1jlhp4ncj = { register: register };
  ...
  var $_6v9fkqx3jlhp4ncp = { register: register$1 };
  ...
  var $_dujy5mx4jlhp4ncu = { register: register$2 };
  ...
  var $_k8i4fx5jlhp4ncy = { register: register$3 };
  ...
  var $_9no2nyx6jlhp4nd5 = { register: register$4 };
  ...
  var $_7jva7xx7jlhp4nda = { register: register$5 };
  ...
  var $_6p7ut9x8jlhp4ndh = { register: register$6 };
  ...
  var $_gh946sx9jlhp4ne6 = { register: register$7 };
  ...
  var $_464wb7xajlhp4nec = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_gi1waywyjlhp4nbp.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_9no2nyx6jlhp4nd5.register(editor);
    $_4f2cvax1jlhp4ncj.register(editor);
    $_6p7ut9x8jlhp4ndh.register(editor);
    $_gh946sx9jlhp4ne6.register(editor);
    $_dujy5mx4jlhp4ncu.register(editor);
    $_6v9fkqx3jlhp4ncp.register(editor);
    $_k8i4fx5jlhp4ncy.register(editor);
    $_464wb7xajlhp4nec.register(editor);
    $_7jva7xx7jlhp4nda.register(editor);
  };
  var $_fy7hs2wxjlhp4nbh = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_f12dvmuxjlhp4mub,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_9n98mbuzjlhp4mvj,
      Panel: Panel,
      Movable: $_8ut9ieukjlhp4mrb,
      Resizable: $_di8fl0v1jlhp4mvu,
      ...
      FormatControls: $_fy7hs2wxjlhp4nbh,
  ...
  global.add('modern', function (editor) {
    $_fy7hs2wxjlhp4nbh.setup(editor);
    return $_c8zvcktqjlhp4mng.get(editor);
  });
  function Theme () {
  }

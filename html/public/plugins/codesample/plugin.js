...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_7o42z9agjlhp4fw8.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_d8mkvmabjlhp4fu1.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_aaez2jadjlhp4fu4.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_74h30yahjlhp4fwb = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_9855uqaajlhp4ftz = {
    open: function (editor) {
      var minWidth = $_d8mkvmabjlhp4fu1.getDialogMinWidth(editor);
      var minHeight = $_d8mkvmabjlhp4fu1.getDialogMinHeight(editor);
      var currentLanguage = $_74h30yahjlhp4fwb.getCurrentLanguage(editor);
      var currentLanguages = $_74h30yahjlhp4fwb.getLanguages(editor);
      var currentCode = $_aaez2jadjlhp4fu4.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_aaez2jadjlhp4fu4.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_7o42z9agjlhp4fw8.isCodeSample(node)) {
        $_9855uqaajlhp4ftz.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_d0lk6sa9jlhp4ftx = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_7o42z9agjlhp4fw8.trimArg($_7o42z9agjlhp4fw8.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_7o42z9agjlhp4fw8.trimArg($_7o42z9agjlhp4fw8.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_cpgvrwaijlhp4fwe = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_d8mkvmabjlhp4fu1.getContentCss(editor);
  ...
  var $_ge4q6qajjlhp4fwh = { loadCss: loadCss };
  ...
  var $_3yiwzdakjlhp4fwk = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_cpgvrwaijlhp4fwe.setup(editor);
    $_3yiwzdakjlhp4fwk.register(editor);
    $_d0lk6sa9jlhp4ftx.register(editor);
    editor.on('init', function () {
      $_ge4q6qajjlhp4fwh.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_7o42z9agjlhp4fw8.isCodeSample(ev.target)) {
        $_9855uqaajlhp4ftz.open(editor);
      }
    });
  });
